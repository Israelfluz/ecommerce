...
class Cart extends Model {
	...
	public function save()
	{
		...
		$results = $sql->select("CALL sp_carts_save(:idcart, :dessessionid, :iduser, :deszipcode, :vlfreight, :nrdays)", [
			...
			':dessessionid'=>$product->getdessessionid(),
	...
	public function getProducts()
	{
		...
		$row = $sql->select("
			SELECT b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheigth, b.vllength, b.vlweight, b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal 
