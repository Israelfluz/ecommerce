...
class User extends Model {
	...
	public funcion get($iduser)
	{

		$sql = new Sql();

		$results = $sql->select("SELECT * FROM tb_users a INNER JOIN tb-persons b USING(idperson) WHERE a.iduser = :iduser", array(
			":iduser"=>$iduser
		));
		...
		else
		{
			...
			else
			{
				...
				if ($inadmin === true) {
						...
						$link = "http://www.hcodecommerce.com.br/ecommerce/views/admin/forgot.reset?code=$code";
	...
	public static function validForgotDecrypt($code)
	{
		...
		$results = $sql->selec("
			SELECT *
			FROM tb_userpasswordrecoveries a
	...
	public function setPassword($password)
	{
		...
		$sql->query("UPDATE tb_users GET despassword = :password WHERE iduser = :iduser", array(
			":password"=>$password,
			":iduser"=>$this->getiduser()
		));
